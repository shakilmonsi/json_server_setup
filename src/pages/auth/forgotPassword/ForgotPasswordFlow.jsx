...
//     const forgotPass = event.target.email.value;
//     console.log(forgotPass);
//   };
//   return (
//     <div className="flex h-screen w-full items-center justify-center bg-[#EEF5FF]">
//       <form
...
//           <span className="font-bold text-[#545454]">contact@gmai.com</span>
//         </p>
...
//         {/* OTP Inputs */}
//         <div className="my-6 flex justify-between gap-2 md:my-10">
//           {otp.map((digit, index) => (
//             <input
//               key={index}
//               type="text"
...
//   return (
//     <div className="flex h-screen w-full items-center justify-center bg-[#EEF5FF]">
//       <form className="w-full max-w-md p-6 md:p-10">
